...
class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
    ...
    render() {
        if (this.state.hasError) {
            return (
                <div className="flex items-center justify-center min-h-screen bg-pink-50 text-center p-4">
                    <div className="bg-white/80 backdrop-blur-md p-8 rounded-2xl shadow-xl border border-pink-100">
                        <h1 className="text-2xl font-bold text-pink-600 mb-4">Algo salió mal</h1>
